...
````css
#components-table-demo-full-feature .toolbar {
  margin-bottom: 16px;
}

#components-table-demo-full-feature .actions {
  float: right;
}

#components-table-demo-full-feature .batch-actions {
  float: left;
}
...
#components-table-demo-full-feature .table-container.full-screen .toolbar {
  background-color: #fafafa;
  margin-bottom: 0;
}

#components-table-demo-full-feature .table-container.full-screen .batch-actions {
  padding: 16px;
}

#components-table-demo-full-feature .table-container.full-screen .shrink-btn {
  cursor: pointer;
  height: 64px;
  width: 64px;
  border: none;
